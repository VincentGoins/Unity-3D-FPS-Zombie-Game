...
namespace Unity.FPS.Gameplay
{
    public class ProjectileStandard : ProjectileBase
    {
        ...
        new void OnShoot()
        {
            ...
            if (playerWeaponsManager)
            {
                ...
                if (Physics.Raycast(playerWeaponsManager.WeaponCamera.transform.position, cameraToMuzzle.normalized,
                    out RaycastHit hit, cameraToMuzzle.magnitude, 1, k_TriggerInteraction))
        ...
        void Update()
        {
            ...
            // Hit detection
            {
                ...
                RaycastHit[] hits = Physics.SphereCastAll(m_LastRootPosition, Radius,
                    displacementSinceLastFrame.normalized, displacementSinceLastFrame.magnitude, 1,
        ...
        void OnHit(Vector3 point, Vector3 normal, Collider collider)
        {
            ...
            {
                // area damage
                AreaOfDamage.InflictDamageInArea(Damage, point, LayerMask.NameToLayer("Default"), k_TriggerInteraction,
