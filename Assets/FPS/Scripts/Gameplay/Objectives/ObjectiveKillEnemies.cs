	  ...
	  Health size; 
        ...
        void OnEnemyKilled(EnemyKillEvent evt)
        {
            ...
            if (MustKillAllEnemies)
                KillsToCompleteObjective = size.zombiesArray;/*evt.RemainingEnemyCount + m_KillTotal;*/

            int targetRemaining = size.zombiesArray; /*MustKillAllEnemies ? evt.RemainingEnemyCount : KillsToCompleteObjective - m_KillTotal;*/
